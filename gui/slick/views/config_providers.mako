...
$(document).ready(function(){
    % if sickbeard.USE_NZBS:
        ...
        $(this).addProvider('${curNewznabProvider.get_id()}', '${curNewznabProvider.name}', '${curNewznabProvider.url}', '${curNewznabProvider.key}', '${curNewznabProvider.categories}', ${int(curNewznabProvider.default)}, show_nzb_providers);
        % endfor
    % endif
